...
const SYSTEM_PROMPT =
  ...
  '- lineup: artiesten/acts genoemd in tekst OF in titel, met optionele rol. Geldige rollen: "dj", "support", "headliner", "act". UITZONDERING op de strikte-regel: voor concert/show-events MAG de hoofd-act uit de titel komen — als de titel duidelijk een artiestnaam IS (bv. "Guns N\' Roses", "Sevdaliza · Sky in Reverse", "Trentemøller - Forever 21 Tour") dan opnemen als {name, role:"headliner"}. Voor "Naam Toernaam · Tour-titel" → alleen "Naam Toernaam" als headliner. Voor titels zonder duidelijke artiestnaam (bv. "Album launch night", "Disco Inferno") → géén titel-extractie, alleen wat in de description staat. GEEN generieke placeholders als naam ("support", "special guest", "tba", "opening act", "onbekend"); zulke aanduidingen horen alleen in `role`, niet in `name`. Skip ze als er geen echte naam bij staat.\n' +
