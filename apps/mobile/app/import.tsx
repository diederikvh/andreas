...
const styles = StyleSheet.create({
  ...
  recognition: { gap: 10, paddingTop: 6 },
  field: { gap: 6 },
  ...
  openEvent: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  openEventText: { fontFamily: fontFamily.monoMedium, fontSize: 12 },
  intentChip: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  intentLabel: { fontFamily: fontFamily.medium, fontSize: 14 },
  suggestedDot: { width: 5, height: 5, borderRadius: 3 },
  matchScore: { fontFamily: fontFamily.mono, fontSize: 12 },
  ...
  fileName: { fontFamily: fontFamily.medium, fontSize: 15 },
  fileMeta: { fontFamily: fontFamily.mono, fontSize: 12 },
