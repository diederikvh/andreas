...
**Playwright (bewust niet in matrix):** bimhuis, ontheroof, radioradio, foam — runnen lokaal via `pnpm scrape <name>`, dagelijks 09:00 via `apps/api/scripts/scrape-local.sh` + launchd. fourvenues, paradiso, melkweg en muziekgebouw zaten hier ook in tot ze naar HTTP gingen.
